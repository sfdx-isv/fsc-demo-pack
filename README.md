# Financial Services Cloud Demo Pack

This repository contains an [AppExchange Demo Kit (ADK) Recipe](config/demo-recipe.json) and associated [Salesforce Metadata](mdapi-source) that can collectively be used to build a fully-functional Financial Services Cloud (FSC) demo in a Scratch Org. 
